...
export class TaskNewComponent implements OnInit {
  ...
  constructor(public activeModal: NgbActiveModal,
    ...
    if (this.common.params != null) {
      ...
      this.userGroupList = this.common.params.groupList.map(x=>{return{id:x._id,name:x.name,groupId:x._id,groupuser:x._employee} });
      this.userWithGroup.push(this.userList.concat(this.userGroupList))
